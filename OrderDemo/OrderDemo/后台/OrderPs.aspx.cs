...
{
    public partial class OrderPs : System.Web.UI.Page
    {
        ...
        private void Show()
        {
            this.GridView1.DataSource = OrderManager.Select4();
        ...
        protected void ImageButton2_Click(object sender, ImageClickEventArgs e)
        {
            ...
            {
                Response.Write("<script>alert('结算失败！')</script>");
            }
        }
    }
}