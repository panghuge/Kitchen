<%@ Page Title="" Language="C#" MasterPageFile="~/后台/ShowInfo.Master" AutoEventWireup="true" CodeBehind="OrderPs.aspx.cs" Inherits="OrderDemo.后台.OrderPs" %>
    ...
    <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" CssClass="table" AllowPaging="True" OnPageIndexChanging="GridView1_PageIndexChanging" PageSize="5">
        <Columns>
            ...
            <asp:TemplateField HeaderText="订单状态">
                <ItemTemplate>
                    <asp:Label ID="Label1" runat="server" Text="派送中"></asp:Label>
                </ItemTemplate>
            </asp:TemplateField>
