<%@ Page Title="" Language="C#" MasterPageFile="~/后台/ShowInfo.Master" AutoEventWireup="true" CodeBehind="OrderJie.aspx.cs" Inherits="OrderDemo.后台.OrderJie" %>
    ...
    <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" CssClass="table" AllowPaging="True" OnPageIndexChanging="GridView1_PageIndexChanging" PageSize="5">
        <Columns>
            ...
            <asp:TemplateField HeaderText="订单状态">
                <ItemTemplate>
                    <asp:Label ID="Label1" runat="server" Text="已接单"></asp:Label>
                </ItemTemplate>
            </asp:TemplateField>
            <asp:TemplateField HeaderText="操作">
                <ItemTemplate>
                    <asp:ImageButton ID="ImageButton1" runat="server" ImageUrl="~/img/detail.jpg"/>
                    <asp:ImageButton ID="ImageButton2" runat="server" ImageUrl="~/img/send.jpg" OnClick="ImageButton2_Click"/>
                </ItemTemplate>
            </asp:TemplateField>
        </Columns>
    </asp:GridView>
