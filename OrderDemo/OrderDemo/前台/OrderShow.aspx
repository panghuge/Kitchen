<%@ Page Title="" Language="C#" MasterPageFile="~/前台/IndexInfo.Master" AutoEventWireup="true" CodeBehind="OrderShow.aspx.cs" Inherits="OrderDemo.前台.OrderShow" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div style="width: 1000px; height: auto; background: #ffe4c4">
        ...
        <div style="width: 950px; height: auto; background: white; margin: 10px auto;">
                    ...
                    <ItemTemplate>
                        <tr>
                            ...
                            <td style="background: #F6F5F3; text-align: center;">
                                <img style="width: 200px; height: 50px;" src="../img/<%# Eval("PicUrl") %>"/></td>
            ...
            <div id="div2">
                <asp:Button ID="Button1" runat="server" Text="立即下单" CssClass="btn-btn" OnClick="Button1_Click" />
            </div>
        </div>
    </div>
</asp:Content>
